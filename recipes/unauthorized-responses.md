...
If you're using [Redux Resource XHR](../ecosystem-extras/redux-resource-xhr.md), then this will be set for you. You can access the status code at `action.requestProperties.statusCode`.
