...
describe('reducerGenerator:', function() {
  ...
  it('passing mixed resources array and no request', () => {
    const state = {
      meta: {
        1: {
          pastaStatus: requestStatuses.PENDING,
  ...
  it('passing resources and no request', () => {
    const state = {
      meta: {
        1: {
          pastaStatus: requestStatuses.PENDING,
  ...
  it('passing no IDs, but passing a request', () => {
    const state = {
      meta: {
        1: {
          pastaStatus: requestStatuses.PENDING,
  ...
  it('passing IDs and passing a request', () => {
    const state = {
      meta: {
        1: {
          pastaStatus: requestStatuses.PENDING,
  ...
  it('passing IDs and passing a request with `mergeMeta: false`', () => {
    const state = {
      meta: {
        1: {
          pastaStatus: requestStatuses.PENDING,
