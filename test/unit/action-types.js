...
describe('actionTypes', function() {
  ...
  describe('create', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.CREATE_RESOURCE_ABORT).to.equal('CREATE_RESOURCE_ABORT');
  ...
  describe('createMany', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.CREATE_MANY_RESOURCES_ABORT).to.equal('CREATE_MANY_RESOURCES_ABORT');
  ...
  describe('read', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.READ_RESOURCE_ABORT).to.equal('READ_RESOURCE_ABORT');
  ...
  describe('readMany', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.READ_MANY_RESOURCES_ABORT).to.equal('READ_MANY_RESOURCES_ABORT');
  ...
  describe('update', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.UPDATE_RESOURCE_ABORT).to.equal('UPDATE_RESOURCE_ABORT');
  ...
  describe('updateMany', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.UPDATE_MANY_RESOURCES_ABORT).to.equal('UPDATE_MANY_RESOURCES_ABORT');
  ...
  describe('delete', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.DELETE_RESOURCE_ABORT).to.equal('DELETE_RESOURCE_ABORT');
  ...
  describe('deleteMany', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.DELETE_MANY_RESOURCES_ABORT).to.equal('DELETE_MANY_RESOURCES_ABORT');
