...
describe('actionTypes', function() {
  ...
  describe('create', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.CREATE_RESOURCES_NIL).to.equal('CREATE_RESOURCES_NIL');
    });
  });
  ...
  describe('read', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.READ_RESOURCES_NIL).to.equal('READ_RESOURCES_NIL');
    });
  });
  ...
  describe('update', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.UPDATE_RESOURCES_NIL).to.equal('UPDATE_RESOURCES_NIL');
    });
  });
  ...
  describe('delete', () => {
    it('should have the right actionTypes', () => {
      ...
      expect(actionTypes.DELETE_RESOURCES_NIL).to.equal('DELETE_RESOURCES_NIL');
    });
  });
});
